...
const ProductForm = ({ type, product, productId }: { type: "Create" | "Update"; product?: Product; productId?: string }) => {
  ...
  const form = useForm<z.infer<typeof insertProductSchema> | z.infer<typeof updateProductSchema>>({
  ...
  return (
    <Form {...form}>
      <form method="post" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className="flex flex-col gap-5 md:flex-row items-baseline">
          <FormField
        ...
        <div>
          <Button type="submit" size={"lg"} disabled={form.formState.isSubmitting} className="w-full button col-span-2">
