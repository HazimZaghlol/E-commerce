  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div className="h-56 w-full">
        <img className="mx-auto h-full rounded" src={props.imageCover} />
      </div>
      <div className="pt-6">
        <div className="mb-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center justify-end gap-1">
            ...
            {isAuthenticated ? (
              <button
                onClick={() => wishlistAdd.mutate(props._id)}
                type="button"
        ...
        <div className="mt-2 flex items-center gap-2">
          ...
          <p className="text-sm font-medium text-gray-900 dark:text-white">{props.ratingsAverage}</p>
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">({props.sold})</p>
        </div>
        <ul className="mt-2 flex items-center gap-4">
          <li className="flex items-center gap-2">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Brand:</p>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{props.brand.name}</p>
          </li>
        </ul>
